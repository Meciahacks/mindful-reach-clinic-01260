...
const Mission = () => {
  ...
  return (
    <section id="mission" className="py-20 bg-muted/50 relative overflow-hidden">
      ...
      />
      <div 
        className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-secondary/10 to-transparent rounded-full blur-3xl"
        style={{ transform: `translateY(${-parallaxOffset * 0.5}px)` }}
      />
